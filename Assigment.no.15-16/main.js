var GuestList = ["Amir", "Ali", "Asim", "Anus"];
//Print the name of the person who is not invited dinner
var uneableAttend = GuestList.splice(1, 1)[0];
console.log("".concat(uneableAttend, ", not invited for dinner"));
//Using Push
GuestList.push("Abdul qadir");
//Print a new message for each person one by one
GuestList.forEach(function (message) {
    console.log("Dear ".concat(message, ", your are invited to my house Party"));
});
...
//using foreach
GuestList.forEach(function (NewMessage) {
    console.log("Dear ".concat(NewMessage, ", You all are Invuted to my bbq Party"));
});
